...
//	int endHeRunNumber = 22437;
	...
	int HeRunNumber = 22054;
	int endHeRunNumber = 22081;

	double bins = endHeRunNumber - HeRunNumber;
...
/*	TString imagename = "Asymmetries/Longitudinal_Beam_Asymmetry_vs_Run_Number_for_Q2_of_";
	imagename += Q2;
	imagename += ".png";
	c1->Print(imagename);
*/
