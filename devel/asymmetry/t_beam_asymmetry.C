...
//		This line below is useful for debugging purposes
		thisHeRunNumber=99999999;
	}
	...
	chainHe->Draw("PriKineR.nu>>histNu(100,0.3,0.8)", cuts, "");
	...
	chainHe->Draw("g0hel.R.helicity:(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histHel", cuts, "");
	histHel->Draw("COLZ");
	...
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxIn", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>22466", "");
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxOut", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun<22469", "");
	histPosHelxIn->Sumw2();
	...
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxIn", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>22466", "");
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxOut", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun<22469", "");
	histNegHelxIn->Sumw2();
...
//	histNegHelx->Sumw2();
	...
	TString imagename = "Asymmetries/Transverse_Beam_Asymmetry_for_Q2_of_";
	imagename += Q2;
	imagename += ".png";
	c1->Print(imagename);
