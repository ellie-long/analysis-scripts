...
void right_v_target_asymmetry_2(){
...
//	double chargeScaleNegL = 1/0.056143;
	double chargeScalePosR = 1/0.042661;
	double chargeScaleNegR = 1/0.045067;
	double xmax = 3.0;
*/
...
//	HeThetaPhiNoCut->Add(HeThetaPhiNoCutR,HeThetaPhiNoCutL);
	...
	chainHeR->Draw("ExTgtCor_R.th:ExTgtCor_R.ph>>HeThetaPhiCut", targetR && thetaphiR, "");
...
//	HeThetaPhiCut->Add(HeThetaPhiCutR,HeThetaPhiCutL);
	...
	chainHeR->Draw("PriKineR.Q2>>histQ2", cutsR, "");	
...
//	histQ2->Add(histQ2R,histQ2L);
	...
	chainHeR->Draw("PriKineR.nu>>histNu", cutsR, "");
...
//	TH2F *histHelL = new TH2F("histHelL",titleHel,bins,xmin,xmax,7,-2,2);
	...
	chainHeR->Draw("he3R.Spin:(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histHel", cutsR, "");
...
//	TH1F *histPosHelxL = new TH1F("histPosHelxR",titlePosHelx,bins,xmin,xmax);
	...
	chainHeR->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelx", cutsR && "he3R.Spin==1", "");
...
//	TH1F *histNegHelxL = new TH1F("histNegHelxL",titleNegHelx,bins,xmin,xmax);
	...
	chainHeR->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelx", cutsR && "he3R.Spin==-1", "");
...
//	histx->Add(histxR,histxL);
	...
	pad11->cd();
	TF1 *fitasym = new TF1("fitasym","[0]",xmin,xmax);
