...
void right_v_target_asymmetry_3(){
...
// ****************************************************************************************************************
	...
	TCanvas *asymCanvas = new TCanvas("asymCanvas","Right Arm Asymmetry Test",800,600); //x,y
	asymCanvas->cd();
	asymCanvas->SetGrid();
...
//	chainHeR->Draw("R.ps.e:R.sh.e>>HePsShCut", "", "");
	...
	TString imagename = "Asymmetries/Right_Arm_Vertical_Target_Asymmetry_for_Q2_of_";
	imagename += Q2;
	imagename += ".png";
