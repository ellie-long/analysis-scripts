...
//		The line below is useful for debugging purposes
		thisHeRunNumber=9999999;
	}
	...
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxIn", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun<22413", "");
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxOut", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>22412", "");
	histPosHelxIn->Sumw2();
	...
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxIn", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun<22413", "");
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxOut", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>22412", "");
	histNegHelxIn->Sumw2();
