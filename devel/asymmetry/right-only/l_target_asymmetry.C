...
void l_target_asymmetry(){

	TString Q2 = "1.0";

	int HeRunNumber = 22393;
	int endHeRunNumber = 22437;
...
//	histPosHelx->Add(histPosHelxIn,histPosHelxOut);
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.omega * 2 * 0.9315))>>histPosHelx", cuts && "he3R.Spin==1", "");
	histPosHelx->Draw();
...
//	histNegHelx->Sumw2();
	...
	TString imagename = "Asymmetries/Longitudinal_Target_Asymmetry_for_Q2_of_";
	imagename += Q2;
	imagename += ".png";
	c1->Print(imagename);
