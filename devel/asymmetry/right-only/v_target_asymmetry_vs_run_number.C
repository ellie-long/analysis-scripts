...
void v_target_asymmetry_vs_run_number(){

	TString Q2 = "0.13";

	int HeRunNumber = 20471;
	int endHeRunNumber = 20471;
...
//	int endHeRunNumber = 20879;
	...
	double bins = (endHeRunNumber - HeRunNumber) + 1;
	double xmin = HeRunNumber;
	double xmax = endHeRunNumber;
...
//	TCut eventtype = "(D.evtypebits&2)==2";
	...
	TCut sieve = "abs(ExTgtCor_R.ph)<0.03 && abs(ExTgtCor_R.th)<0.065";
	...
	chainHe->Draw("ExTgtCor_R.dp>>HedpCut(400,-0.08,0.08)", gold, "");
	...
	chainHe->Draw("ExTgtCor_R.th:ExTgtCor_R.ph>>HeSieveNoCut(100,-0.05,0.05,100,-0.1,0.1)", target, "");
	...
	chainHe->Draw("ExTgtCor_R.th:ExTgtCor_R.ph>>HeSieveCut(100,-0.05,0.05,100,-0.1,0.1)", target && sieve, "");
	...
	chainHe->Draw("PriKineR.nu>>histNu(100,0,0.8)", cuts, "");
	...
	chainHe->Draw("he3R.Spin:(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histHel", cuts, "");
	histHel->Draw("COLZ");
	pad7->Update();


	// Note: For all plots below, Positive Beam Helicity is defined as g0hel.R.helicity==1 when the BHWP is In
	// and g0hel.R.helicity==-1 when the BHWP is Out.
	//
	// Positive Target Helicity is defined as he3R.Spin==1.

	pad8->cd();
	TString titlePosHelx = "# of Positive Target Helicity Events vs. Run #";
...
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxIn1", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>20576" && "fEvtHdr.fRun<20684", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxIn2", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>20728" && "fEvtHdr.fRun<20813", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxOut1", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>20683" && "fEvtHdr.fRun<20728", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelxOut2", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>20813" && "fEvtHdr.fRun<20879", "");
...
//	histPosHelx->Add(histPosHelxIn,histPosHelxOut);
	chainHe->Draw("fEvtHdr.fRun>>histPosHelx", cuts && "he3R.Spin==1", "");
	histPosHelx->Draw();
	pad8->Update();

	pad9->cd();
	TString titleNegHelx = "# of Negative Target Helicity Events vs. Run #";
...
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxIn1", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>20576" && "fEvtHdr.fRun<20684", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxIn2", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>20728" && "fEvtHdr.fRun<20813", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxOut1", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>20683" && "fEvtHdr.fRun<20728", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelxOut2", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun>20813" && "fEvtHdr.fRun<20879", "");
...
//	histNegHelx->Add(histNegHelxIn,histNegHelxOut);
	chainHe->Draw("fEvtHdr.fRun>>histNegHelx", cuts && "he3R.Spin==-1", "");
	histNegHelx->Draw();
	pad9->Update();
	...
	histx->Sumw2();
	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histx", cuts, "E");
	histx->Draw();
	pad10->Update();
	...
	pad11->cd();
	TString titleAsym = "Target Asymmetry (%) vs. Run Number for Q2 of ";
	titleAsym += Q2;
...
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelIn", cuts && "g0hel.R.helicity==1" && "fEvtHdr.fRun<22413", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHelOut", cuts && "g0hel.R.helicity==-1" && "fEvtHdr.fRun>22412", "");
//	histPosHelIn->Sumw2();
//	histPosHelOut->Sumw2();
...
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelIn", cuts && "g0hel.R.helicity==-1" && "fEvt.fRun<22413", "");
//	chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHelOut", cuts && "g0hel.R.helicity==1" && "fEvt.fRun>22412", "");
//	histNegHelIn->Sumw2();
//	histNegHelOut->Sumw2();
...
/*	TString imagename = "Asymmetries/Vertical_Target_Asymmetry_vs_Run_#_for_Q2_of_";
	imagename += Q2;
	imagename += ".png";
	c1->Print(imagename);
*/
