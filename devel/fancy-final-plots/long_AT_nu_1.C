...
const char* psfile = "long_AT_nu_1";

using namespace std;

datafile_t datafiles[] = {
//{ "data file.dat", "Data Name", "Q2", "AT", "Error Up", "Error Down", ?, ?, Shape, Color}
  { "asym_datafiles/AT_Long_nu_q2_1.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
//  { "asym_datafiles/AT_Long_nu_q2_1_raw.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
  { NULL }
};  
...
//  { "asym_theory/mami_ay_theory_full.txt", "FSI and MEC (Faddeev)", "[0]", "[1]", "0", "0", 0, 0, 2, 3 },
  { "asym_theory/trans_long_1_qe_peak.txt", "Central QE Peak", "[0]", "[1]", "0", "0", 0, 0, 2, 3 },
  { NULL }
};
...
void long_AT_nu_1() {
  ...
  frm->GetYaxis()->SetTitle("AT for Q2=0.953 (GeV/c)2");
  frm->SetMinimum(-.05);
//  frm->SetMinimum(0);
//  frm->SetMaximum(1.0);
  frm->SetMaximum(0.03);
