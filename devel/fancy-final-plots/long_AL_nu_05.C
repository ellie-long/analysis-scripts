...
const char* psfile = "long_AL_nu_05";

using namespace std;

datafile_t datafiles[] = {
//{ "data file.dat", "Data Name", "Q2", "AL", "Error Up", "Error Down", ?, ?, Shape, Color}
  { "asym_datafiles/AL_Long_nu_q2_05.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
//  { "asym_datafiles/AL_Long_nu_q2_05_raw.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
  { NULL }
};  

datafile_t theoryfiles1[] = {
//{ "theory file.txt", "Data Name", "Q2 (Include range in theory file)", "AL", "Error Up", "Error Down", ?, ?, 2, 3 },
...
void long_AL_nu_05() {
  ...
  frm->GetYaxis()->SetTitle("AL for Q2=0.505 (GeV/c)2");
  frm->SetMinimum(-0.15);
//  frm->SetMinimum(0);
//  frm->SetMaximum(1.0);
  frm->SetMaximum(0.15);
