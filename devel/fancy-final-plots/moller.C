...
const char* psfile = "moller";

using namespace std;

datafile_t datafiles[] = {
//{ "data file.day", "Data Name", "Q2", "EPR", "Error Up", "Error Down", ?, ?, Shape, Color}
//  { "moller_datafiles/moller_date.dat", "Moller", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,4 },
  { "moller_datafiles/moller_days.dat", "Moller", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,4 },
  { NULL }
};  
...
void moller() {
  ...
  cn->Draw();
  cn->UseCurrentStyle();
//  TH1F *frm = new TH1F("EPR","",100,2009.04,2009.055);
  TH1F *frm = new TH1F("EPR","",50,1,50);
  frm->SetStats(kFALSE);
//  frm->GetXaxis()->SetTitle("Date");
  frm->GetXaxis()->SetTitle("# of Days with 1 = 04/15/2009");
