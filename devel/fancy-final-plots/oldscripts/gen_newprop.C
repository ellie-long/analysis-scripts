...
//  { "formfactor_datafiles/GEn_Passchier.dat", "Passchier", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])",0,0, 5,1,"p" },
 ...
 //  {"formfactor_datafiles/GEn_Geis.dat", "Geis","[0]","[1]","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,kGreen},
  ...
  { "e02013_nofsi.dat", "x","[0]","[1]","[2]","[2]",0,0,22,kBlack,"p"},
  //{ "e02013_results.dat", "E02-013","[0]","[1]","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,2,"p"},
  { "e02013_nofsi.dat", "E02-013 (Preliminary)","[0]","[1]","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,kBlack,"p"},
 // {"e02013_proposal.dat", "x","[0]","[1]","[2]","[2]",0,0,22,2},
//  {"e02013_proposal.dat", "x","[0]","0","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,2},
 ...
 // {"12gevprop_10.dat", "12 GeV Plans","[0]","0","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,kBlack},
  {"gen_newprop.dat", "PR-09-016","[0]","0","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,kRed},
...
//
	{ "figure_input/Miller/GEn.dat.spl3",             "CQM - J. Miller",   "[0]", "[1]", "0", "0", 0, 0, 1, 8 },
	{ "figure_input/Lomon/gen.dat.2",             "VMD - E. Lomon (2002)",   "[0]", "[1]", "0", "0", 0, 0, 2, 4 },
...
Double_t genff(Double_t *x, Double_t *p) {
	Double_t Q2=*x;
	Double_t scl=p[0];
	Double_t tau=Q2/(4*.939565*0.939565);
	Double_t ch=0.;
	Double_t kappa=-1.91;
...
Double_t gengmnffq2(Double_t *x, Double_t *p) {
	Double_t Q2=*p;
	Double_t scl=x[0];
	Double_t tau=Q2/(4*.939565*0.939656);
	Double_t ch=0.;
	Double_t kappa=-1.91;
	Double_t lambda = .3; // GeV, lambda = 300 MeV
	Double_t L2 = .71;
...
void gen_newprop() {
	...
	TF1* galst = new TF1("Galster",galster,0.,12.,0);
	...
	TLegend *legThry = new TLegend(.198,.834,.514,.905,"","brNDC");
...
//	legThry->AddEntry(genf,"F_{2}/F_{1} #propto ln^{2}(Q^{2}/#Lambda^{2})/Q^{2}","l");
	legThry->AddEntry(galst,"Galster fit (1971)","l");
	legThry->Draw();
