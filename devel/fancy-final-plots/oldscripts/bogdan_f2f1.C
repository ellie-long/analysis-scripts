...
datafile_t datafiles[] = {
  ...
  { "formfactor_datafiles/GEn_Madey.dat", "Madey", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,22,2,"p" },
...
//  { "e02013_proposal.dat", "E02-013 (proj)","[0]","0","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,26,2,"p"},
  { "e02013_errbars.dat", "E02-013 (preliminary)","[0]","0","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,20,2,"p"},
  { "e02013_errbars.dat", "E02-013 (preliminary)","[0]","0","[2]","[2]",0,0,8,4,"p"},
//  { "e02013_results.dat", "E02-013 (results)","[0]","[1]","[2]","[2]",0,0,20,4,"p"},
...
void bogdan_f2f1() {
  ...
  frm->GetYaxis()->SetTitle("- Q^{2} F_{2}^{n}/F_{1}^{n}");
  frm->SetMinimum(0.);
  frm->SetMaximum(10.);
  frm->UseCurrentStyle();
  frm->Draw();
  ...
  galst->SetLineColor(4);
  galst->SetLineStyle(1);


  TF1 *genf = new TF1("f2f1",f2f1,1.6,10.,1);
  genf->SetLineColor(2);
  genf->SetLineStyle(2);
