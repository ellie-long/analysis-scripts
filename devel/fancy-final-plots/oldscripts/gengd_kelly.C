...
//  { "formfactor_datafiles/GEn_Eden.dat", "Eden", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])",0,0, 23,kBlue },
  ...
  // NIKHEF
  { "formfactor_datafiles/GEn_Passchier.dat", "Passchier, NIKHEF", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])",0,0, 5,kBlack },
 // Corrected by Golak
  // MAMI - Deuterium Polarization
  { "formfactor_datafiles/GEn_Herberg.dat", "Herberg, MAMI", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,23,kBlack },
  { "formfactor_datafiles/GEn_Ostrick.dat", "Ostrick, MAMI", "[0]", "[1]", "sqrt([2]*[2]+[4]*[4])", "sqrt([2]*[2]+[3]*[3])", 0,0,29,kBlack },


{ "formfactor_datafiles/GEn_Madey.dat", "Madey, Hall C", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,26,kRed },
...
//  { "formfactor_datafiles/GEn_Seimetz.dat", "Seimetz", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,1 },
  ...
  { "formfactor_datafiles/GEn_Glazier.dat", "Glazier, MAMI", "[0]", "[1]", "[2]", "[2]", 0,0,27,kBlack },
  
  // Replaces Zhu - E93-026
  { "formfactor_datafiles/GEn_Warren.dat", "Warren, Hall C", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,21,kBlack },

  // MAMI - 3He Polarization
  { "formfactor_datafiles/GEn_Meyerhoff.dat", "Meyerhoff, MAMI", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,30,kBlack },
  ...
  { "formfactor_datafiles/GEn_Rohe.dat", "Rohe, MAMI", "[0]", "[1]", "[2]", "[2]", 0,0,3,kBlack },
...
//  { "formfactor_datafiles/GEn_Lung_new.dat", "Lung (Naive Correction)", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,28,kBlue },
 // { "formfactor_datafiles/GEn_Hanson.dat", "Hanson", "[0]", "[1]", "[2]", "[2]", 0,0,30,1 },
  ...
  {"formfactor_datafiles/GEn_Geis.dat", "Geis, BATES","[0]","[1]","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,22,kBlack},
...
#endif
 // { "gen_newprop.dat", "PR09-016, Hall A","[0]","[1]","sqrt([2]*[2]+[3]*[3])","sqrt([2]*[2]+[3]*[3])",0,0,20,2},
...
TGraph *gen_kelly(Double_t Q2min, Double_t Q2max){
	Double_t Q2;
	Double_t tau;
	Double_t points[100];
	...
	Double_t c_up[7] = { 0, 0.457704, -0.31132, 0.175924, -0.049594, 0.00491184, 0, };
	Double_t c_lo[7] = { 0, 0.387174, -0.217339, 0.0588786, -0.0112179, 0.00100009, 0, };
...
//  genf->SetParameter(0,-0.558645);
  ...
  TGraph *kelly = gen_kelly(0.0, 12.);
  kelly->SetLineColor(kWhite);
  kelly->SetFillColor(kCyan-6);
  kelly->SetLineStyle(0);
...
//				  wgr->Add( new TGraph(*egr),"l");
  ...
  kelly->Draw("sameF");
  legThry->AddEntry(kelly, "Kelly LGE Parameterization", "F");
