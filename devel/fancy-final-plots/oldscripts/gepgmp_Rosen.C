...
const char* psfile = "gepgmp_Rosen";
...
datafile_t rosenbluth_files[] = {
  { "formfactor_datafiles/FFR_Janssens.dat", "Janssens", "[0]", "[1]", "[2]", "[2]",0,0,24,1 },
  { "formfactor_datafiles/FFR_Bartel.dat", "Bartel", "[0]", "[1]", "[2]", "[2]",0,0,25,1 },
  { "formfactor_datafiles/FFR_Litt2.dat", "Litt", "[0]", "[1]", "[2]", "[2]",0,0,26,1 },
  { "formfactor_datafiles/FFR_Berger2.dat", "Berger", "[0]", "[1]", "[2]", "[2]",0,0,27,1 },
  { "formfactor_datafiles/FFR_Walker2.dat", "Walker", "[0]", "[1]", "[2]", "[2]",0,0,28,1 },
  { "formfactor_datafiles/FFR_Andivahis.dat", "Andivahis", "[0]", "[1]", "[5]", "[4]",0,0,30,1 },
  { NULL }
};
