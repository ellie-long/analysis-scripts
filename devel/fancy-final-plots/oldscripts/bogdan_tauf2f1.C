...
const char* psfile = "bogdan_tauf2f1";
...
//  { "figure_input/Roberts/gen.dat",             "DSE - C. Roberts",   "[0]", "[1]", "0", "0", 0, 0, 2, kRed },
  ...
  { "figure_input/Miller/GEn.dat.spl3.trunc",             "CQM - G. Miller",   "[0]", "[1]", "0", "0", 0, 0, 1, 8 },
...
//      gr=fromGEntoF2F1(ogr);
  ...
  // GEn = 0 line
  TLine *gen0line = new TLine(0.5, 1.0, 3.0, 1.0);
  gen0line->Draw();
  TPaveLabel *gen0lab = new TPaveLabel(2.5576, 0.35136, 3.6306, 1.3437, "G_{E}^{n} = 0");
