...
const char* psfile = "long_NMR_Ay";

using namespace std;

datafile_t datafiles[] = {
//{ "data file.day", "Data Name", "Q2", "NMR_Ay", "Error Up", "Error Down", ?, ?, Shape, Color}
...
void long_NMR_Ay() {
  ...
  cn->Draw();
  cn->UseCurrentStyle();
  TH1F *frm = new TH1F("NMR_Ay","",491,0,490);
  frm->SetStats(kFALSE);
  frm->GetXaxis()->SetTitle("Spin Flip");
