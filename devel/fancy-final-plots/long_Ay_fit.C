...
//  { "asym_datafiles/Ay_Long.dat", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
  { "asym_datafiles/Ay_for_fit.dat", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
  { NULL }
};  
