...
const char* psfile = "long_AL_nu_1";

using namespace std;

datafile_t datafiles[] = {
//{ "data file.dat", "Data Name", "Q2", "AL", "Error Up", "Error Down", ?, ?, Shape, Color}
  { "asym_datafiles/AL_Long_nu_q2_1.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
//  { "asym_datafiles/AL_Long_nu_q2_1_raw.txt", "This Experiment", "[0]", "[1]", "sqrt([2]*[2]+[3]*[3])", "sqrt([2]*[2]+[3]*[3])", 0,0,20,6 },
  { NULL }
};  
...
void long_AL_nu_1() {
  ...
  frm->GetYaxis()->SetTitle("AL for Q2=0.953 (GeV/c)2");
  frm->SetMinimum(-.09);
//  frm->SetMinimum(-.04);
//  frm->SetMinimum(0);
//  frm->SetMaximum(1.0);
