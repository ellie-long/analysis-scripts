...
void nitrogen_tail_matching_trans_1()
{

//	bool zoomed = false;
	bool zoomed = true;

	int thisHeRunNumber = 22447;
//	int thisNitroRunNumber = 22294;
	...
	int NitroRunNumber = 22442;
	int endNitroRunNumber = 22442;
...
//		filenameHe = "/home/ellie/physics/e05-102/ellana/ROOTfiles/q2_01_vert/e05102_R_";
		filenameHe = "/home/ellie/physics/e05-102/ellana/ROOTfiles/q2_1_transverse/e05102_R_";
	...
	TH1F *hex = new TH1F("hex","hex",100,0,20);
	TH1F *nitrox = new TH1F("nitrox","nitrox",100,0,20);
	chainHe->Draw("PriKineR.x_bj>>hex","ReactPt_R.z>-0.05 && ReactPt_R.z<0.05");
//	chainHe->Draw("PriKineR.x_bj>>hex");
	chainNitro->Draw("PriKineR.x_bj>>nitrox","ReactPt_R.z>-0.05 && ReactPt_R.z<0.05");
...
*/
	pad2->cd();
	cout << "Drawing pad1" << endl;
	TH1F *hexscaled = new TH1F("hexscaled","hexscaled",100,0,20);
	TH1F *nitroxscaled = new TH1F("nitroxscaled","nitroxscaled",100,0,20);
	chainHe->Draw("PriKineR.x_bj>>hexscaled","ReactPt_R.z>-0.05 && ReactPt_R.z<0.05");
//	chainHe->Draw("PriKineR.x_bj>>hexscaled");
	chainNitro->Draw("PriKineR.x_bj>>nitroxscaled","ReactPt_R.z>-0.05 && ReactPt_R.z<0.05");
//	chainNitro->Draw("PriKineR.x_bj>>nitroxscaled");
	hexscaled->Scale(1/(HeChargeScale*Helivetime));
	hexscaled->SetTitle("Scaled xBj");
	hexscaled->Draw();
	nitroxscaled->Scale((1/(NitroChargeScale*Nitrolivetime))*1.00);
