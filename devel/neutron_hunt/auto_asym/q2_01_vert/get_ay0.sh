...
ayhome="${workPrefix}/analysis-scripts/devel/neutron_hunt/auto_asym/q2_01_vert"
...
awk '$1>20000 && $1<30000 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 && $11>0 && $13>0 && $14>0 && $2>0 && $3>0{print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3),$2*$10/($4*$6)*sqrt(1/$11-1/$13+1/($2)),$3*$10/($5*$7)*sqrt(1/$12-1/$13+1/($3))}' $file1 > temp_q2_01_yields.txt
...
awk '$1>20000 && $1<30000 && ($2+$3)>0 {print $1,(($2-$3)/($2+$3))*(1/('$Pt'*'$DN2'*'$Dp')),(1/('$Pt'*'$DN2'*'$Dp'))*(2/((($2/$3)+1)^2))*($2/$3)*sqrt(($5/$2)^2+($6/$3)^2)}' $file2 > temp_final_q2_01_asym_runnum.txt
...
awk '$1>20000 && $1<30000 {print $1,$2,sqrt(($2*'$dDN2'/'$DN2')^2 + ($2*'$dDp'/'$Dp')^2 + ($2*'$dPt'/'$Pt')^2 + $3^2)}' $file9 > final_q2_01_asym_runnum.txt
#							Run #	Ay0		dAy0_tot
#							$1		$2		$3
...
cat final_q2_01_nu_asym_all_errs.txt
