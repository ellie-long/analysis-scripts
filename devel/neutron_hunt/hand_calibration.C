// ***************************************************
//
// This script should make cuts to show the TDC and ADC
// spectra for each plane against the number of bars
// within that plane. I want to figure out a way to use
// this information to calibrate the neutron detector
// so that I can pull out just neutrons from the data.
//
// 08-10-10
// Elena Long
//
