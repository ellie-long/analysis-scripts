...
// The section below prepares to output the Target Asymmetry
// ******************************************************************************************************************************
	...
	cout << "Drawing Spin Up vs. xBj..." << endl;
	TString titleSpinUpx = "Spin Up vs. xBj (Not Scaled) for Runs #";
	titleSpinUpx += HeRunNumber;
	titleSpinUpx += "-";
	titleSpinUpx += endHeRunNumber;
	cout << "Drawing " << titleSpinUpx << "..." << endl;
	TString plotSpinUpx = "HANDSpinUpx";
	TH1F *HANDTotalSpinUpx = new TH1F(plotSpinUpx,titleSpinUpx,xBjbins,xBjmin,xBjmax);
	TString HANDSpinUpxString = "PriKineR.x_bj";
	HANDSpinUpxString += ">>";
	HANDSpinUpxString += plotSpinUpx;
	chainHe->Draw(HANDSpinUpxString, cuts && "he3R.Spin==1","");
	HANDTotalSpinUpx->SetMinimum(0);
	HANDTotalSpinUpx->Draw();
	...
	cout << "Drawing Spin Down vs. xBj..." << endl;
	TString titleSpinDownx = "Spin Down vs. xBj (Not Scaled) for Runs #";
	titleSpinDownx += HeRunNumber;
	titleSpinDownx += "-";
	titleSpinDownx += endHeRunNumber;
	cout << "Drawing " << titleSpinDownx << "..." << endl;
	TString plotSpinDownx = "HANDSpinDownx";
	TH1F *HANDTotalSpinDownx = new TH1F(plotSpinDownx,titleSpinDownx,xBjbins,xBjmin,xBjmax);
	TString HANDSpinDownxString = "PriKineR.x_bj";
	HANDSpinDownxString += ">>";
	HANDSpinDownxString += plotSpinDownx;
	chainHe->Draw(HANDSpinDownxString, cuts && "he3R.Spin==-1","");
	HANDTotalSpinDownx->SetMinimum(0);
	HANDTotalSpinDownx->Draw();
	...
	TString AsymTestTitle = "Target Asymmerty (Not Scaled) vs. xBj for runs ";
