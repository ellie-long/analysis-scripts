...
//	const int xBjbins = 10;
	...
	TString outputPlotsHere = "/home/ellie/physics/e05-102/images/plots_for_hand/hand_beam_asymmetry/";
...
//			HANDrightcut->Scale(1/(HeChargeScale*Helivetime));
			...
			if (includeVetos) {chainHe->Draw(HANDSpinUpxString, cuts && vetoTDCs && goodTDCcut && theCurrentBar && firstTrack && "g0hel.R.helicity==1","");}
			...
			if (includeVetos) {chainHe->Draw(HANDSpinDownxString, cuts && vetoTDCs && goodTDCcut && theCurrentBar && firstTrack && "g0hel.R.helicity==-1","");}
