...
void neutron_hunt(){
	...
	TString Q2 = "1.0";
	int HeRunNumber = 22394;
	int endHeRunNumber = 22394;

//	int HeRunNumber = 22393;
//	int endHeRunNumber = 22393;
...
// **********************************************************************************************
	...
	TString veto1plane = "nd.p1";
	TString veto1bar = "13";
	TString veto2plane = "nd.p1";
	TString veto2bar = "14";
	TString veto3plane = "nd.p1";
	TString veto3bar = "15";
	TString veto4plane = "nd.p2";
	TString veto4bar = "10";
	TString veto5plane = "nd.p2";
	TString veto5bar = "12";
	TString veto6plane = "10";
	TString veto6bar = "12";
...
// the flow of data to histograms
	...
	new TCanvas("hand","Neutron Data",1400,770); //x,y
//	TCanvas *hand = new TCanvas("hand","Neutron Data",1400,770); //x,y
	...
	handpad01->Draw();handpad02->Draw();handpad03->Draw();handpad04->Draw();handpad05->Draw();handpad06->Draw();handpad07->Draw();
	...
	titleHANDleftNoVetos += goodPlane;
	titleHANDleftNoVetos += ", PMT # ";
	titleHANDleftNoVetos += goodPMT;
	titleHANDleftNoVetos += " without vetos";
	cout << "Drawing " << titleHANDleftNoVetos << "..." << endl;
	TH1F *HANDleftNoVetos = new TH1F("HANDleftNoVetos",titleHANDleftNoVetos,100,1,2000);
	TString HANDleftNoVetosTDC = goodTDCl;
	HANDleftNoVetosTDC += ">>HANDleftNoVetos";
	...
	titleHANDrightNoVetos += goodPlane;
	titleHANDrightNoVetos += ", PMT # ";
	titleHANDrightNoVetos += goodPMT;
	titleHANDrightNoVetos += " without vetos";
	cout << "Drawing " << titleHANDrightNoVetos << "..." << endl;
	TH1F *HANDrightNoVetos = new TH1F("HANDrightNoVetos",titleHANDrightNoVetos,100,1,2000);
	TString HANDrightNoVetosTDC = goodTDCr;
	HANDrightNoVetosTDC += ">>HANDrightNoVetos";
	...
	titleHANDleft += goodPlane;
	titleHANDleft += ", PMT # ";
	titleHANDleft += goodPMT;
	titleHANDleft += " with vetos";
	cout << "Drawing " << titleHANDleft << "..." << endl;
	TH1F *HANDleft = new TH1F("HANDleft",titleHANDleft,100,1,2000);
	TString HANDleftTDC = goodTDCl;
	HANDleftTDC += ">>HANDleft";
	...
	titleHANDright += goodPlane;
	titleHANDright += ", PMT # ";
	titleHANDright += goodPMT;
	titleHANDright += " with vetos";
	cout << "Drawing " << titleHANDright << "..." << endl;
	TH1F *HANDright = new TH1F("HANDright",titleHANDright,100,1,2000);
	TString HANDrightTDC = goodTDCr;
	HANDrightTDC += ">>HANDright";
	...
	TH2F *HAND = new TH2F("HAND",titleHAND,100,1,2000,100,1,2000);
	...
	titleHANDlego += goodPlane;
	titleHANDlego += ", PMT # ";
	titleHANDlego += goodPMT;
	titleHANDlego += " with vetos";
	cout << "Drawing " << titleHANDlego << "..." << endl;
	TH2F *HANDlego = new TH2F("HANDlego",titleHANDlego,100,1,2000,100,1,2000);
	TString HANDlegoTDC = goodTDCl;
	HANDlegoTDC += ":";
	HANDlegoTDC += goodTDCr;
	HANDlegoTDC += ">>HANDlego";
