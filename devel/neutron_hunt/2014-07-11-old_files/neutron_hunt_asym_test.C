...
void neutron_hunt_asym_test(){

//	TString Q2 = "1.0";
	int HeRunNumber = 20579;
	int endHeRunNumber = 20579;
	int HANDbins = 100;
	double HANDmin = 1;
//	double HANDmax = 1800;
	double HANDmax = 3100;
...
// **********************************************************************************************
	...
	TString imageCutsTitle = "plots_for_hand/with_asym/HAND_plots_Run_Num_";
	imageCutsTitle += HeRunNumber;
	imageCutsTitle += "_cuts_with_asym";
	imageCutsTitle += ".png";
...
// **********************************************************************************************
	for (int nplane=2; nplane<5; nplane++)
	{
		...
		//	TCanvas *hand = new TCanvas("hand","Neutron Data",1400,770); //x,y
			...
			handpad02 =  new TPad("handpad02","handpad02",0.1000,0.6666,0.4000,1.0000,0,0,0);
			handpad03 =  new TPad("handpad03","handpad03",0.1000,0.3333,0.4000,0.6666,0,0,0);
			handpad04 =  new TPad("handpad04","handpad04",0.4000,0.6666,0.7000,1.0000,0,0,0);
			handpad05 =  new TPad("handpad05","handpad05",0.7000,0.6666,1.0000,1.0000,0,0,0);
			...
			if (goodBar.Contains("veto.10")) p0b10->SetFillColor(3); 
			p0b10->Draw();
			...
			if (goodBar.Contains("veto.11")) p0b11->SetFillColor(3); 
			p0b11->Draw();
			...
			if (goodBar.Contains("veto.12")) p0b12->SetFillColor(3); 
			p0b12->Draw();
			...
			if (goodBar.Contains("veto.13")) p0b13->SetFillColor(3); 
			p0b13->Draw();
			...
			if (goodBar.Contains("veto.14")) p0b14->SetFillColor(3); 
			p0b14->Draw();
			...
			if (goodBar.Contains("veto.15")) p0b15->SetFillColor(3); 
			p0b15->Draw();
			...
			if (goodBar.Contains("veto.16")) p0b16->SetFillColor(3); 
			p0b16->Draw();
			...
			if (goodBar.Contains("veto.17")) p0b17->SetFillColor(3); 
			p0b17->Draw();
			...
			if (goodBar.Contains("veto.18")) p0b18->SetFillColor(3); 
			p0b18->Draw();
			...
			if (goodBar.Contains("veto.19")) p0b19->SetFillColor(3); 
			p0b19->Draw();
			...
			if (goodBar.Contains("veto.20")) p0b20->SetFillColor(3); 
			p0b20->Draw();
			...
			if (goodBar.Contains("veto.21")) p0b21->SetFillColor(3); 
			p0b21->Draw();
			...
			if (goodBar.Contains("veto.0")) p0b00->SetFillColor(3); 
			p0b00->Draw();
			...
			if (goodBar.Contains("veto.1 ")) p0b01->SetFillColor(3); 
			p0b01->Draw();
			...
			if (goodBar.Contains("veto.2 ")) p0b02->SetFillColor(3); 
			p0b02->Draw();
			...
			if (goodBar.Contains("veto.3 ")) p0b03->SetFillColor(3); 
			p0b03->Draw();
			...
			if (goodBar.Contains("veto.4")) p0b04->SetFillColor(3); 
			p0b04->Draw();
			...
			if (goodBar.Contains("veto.5")) p0b05->SetFillColor(3); 
			p0b05->Draw();
			...
			if (goodBar.Contains("veto.6")) p0b06->SetFillColor(3); 
			p0b06->Draw();
			...
			if (goodBar.Contains("veto.7")) p0b07->SetFillColor(3); 
			p0b07->Draw();
			...
			if (goodBar.Contains("veto.8")) p0b08->SetFillColor(3); 
			p0b08->Draw();
			...
			if (goodBar.Contains("veto.9")) p0b09->SetFillColor(3); 
			p0b09->Draw();
			...
			if (goodBar.Contains("veto.22")) p0b22->SetFillColor(3); 
			p0b22->Draw();
			...
			if (goodBar.Contains("veto.23")) p0b23->SetFillColor(3); 
			p0b23->Draw();
			...
			if (goodBar.Contains("veto.24")) p0b24->SetFillColor(3); 
			p0b24->Draw();
			...
			if (goodBar.Contains("veto.25")) p0b25->SetFillColor(3); 
			p0b25->Draw();
			...
			if (goodBar.Contains("veto.26")) p0b26->SetFillColor(3); 
			p0b26->Draw();
			...
			if (goodBar.Contains("veto.27")) p0b27->SetFillColor(3); 
			p0b27->Draw();
			...
			if (goodBar.Contains("veto.28")) p0b28->SetFillColor(3); 
			p0b28->Draw();
			...
			if (goodBar.Contains("veto.29")) p0b29->SetFillColor(3); 
			p0b29->Draw();
			...
			if (goodBar.Contains("veto.30")) p0b30->SetFillColor(3); 
			p0b30->Draw();
			...
			if (goodBar.Contains("veto.31")) p0b31->SetFillColor(3); 
			p0b31->Draw();
			...
			if (goodBar.Contains("nd.p1.7 ")) p1b007>SetFillColor(3);
			p1b07->Draw();
			...
			handpad08->cd();
			TString titlePosHel = "# of Positive Helicity Events vs xBj for Plane # ";
			titlePosHel += nplane;
			titlePosHel += ", PMT # ";
			titlePosHel += thisbar;
			TString goodTDCleftCut = "(";
			goodTDCleftCut += goodTDCl;
			goodTDCleftCut += ">1 && ";
			goodTDCleftCut += goodTDCl;
			goodTDCleftCut += "<1600 )";
			TCut goodTDClCut = goodTDCleftCut;
			TString goodTDCrightCut = "(";
			goodTDCrightCut += goodTDCr;
			goodTDCrightCut += ">1 && ";
			goodTDCrightCut += goodTDCr;
			goodTDCrightCut += "<1600 )";
			TString plotPosHel = "histPosHel_p";
			plotPosHel += nplane;
			plotPosHel += "_b";
			plotPosHel += thisbar;
			TCut goodTDCrCut = goodTDCrightCut;
			TCut asymCuts = cuts && vetoTDCs && (goodTDCrCut || goodTDClCut);
			cout << "Drawing " << titlePosHel << "..." << endl;
			TH1F *histPosHel = new TH1F(plotPosHel,titlePosHel,bins,xmin,xmax);
			chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histPosHel", asymCuts && "g0hel.R.helicity==1", "");
			histPosHel->Draw();
			handpad08->Update();

			handpad09->cd();
			TString titleNegHel = "# of Negative Helicity Events vs xBj for Plane # ";
			titleNegHel += nplane;
			titleNegHel += ", PMT #i ";
			titleNegHel += thisbar;
			TString plotNegHel = "histNegHel_p";
			plotNegHel += nplane;
			plotNegHel += "_b";
			plotNegHel += thisbar;
			cout << "Drawing " << titleNegHel << "..." << endl;
			TH1F *histNegHel = new TH1F(plotNegHel,titleNegHel,bins,xmin,xmax);
			chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>histNegHel", asymCuts && "g0hel.R.helicity==-1", "");
			histNegHel->Draw();
			handpad09->Update();

			handpad10->cd();
			TString titleAsym = "Target Asymmetry (%) vs xBj for Plane # ";
			titleAsym += nplane;
			titleAsym += ", PMT # ";
			titleAsym += thisbar;
			...
			TString imageTitle = "plots_for_hand/with_asym/HAND_plots_Run_Num_";
			imageTitle += HeRunNumber;
			imageTitle += "_p";
			imageTitle += nplane;
			imageTitle += "_b";
			imageTitle += thisbar;
			imageTitle+= "_with_asym.png";
