...
//	TCut eventtype = "(D.evtypebits&2)==2";
	...
	TCut thph = "abs(ExTgtCor_R.ph)<0.025 && abs(ExTgtCor_R.th)<0.06";
...
//		for (int thisbar=8; thisbar<9; thisbar++)
		{
...
//			hand_draw(HeRunNumber, endHeRunNumber, antivetosAsVetos, allVetos, goodBar, allAntivetos);
			hand_draw(HeRunNumber, endHeRunNumber, antivetosAsVetos, allVetos, "", allAntivetos);
			handpad01->Update();
			...
			cout << "goodTDCcutstring: " << goodTDCcutstring;
...
//			chainHe->Draw("ExTgtCor_R.th:ExTgtCor_R.ph>>HeThetaPhiNokinematics", cuts && vetoTDCs && thisplaneandbar, "");
			chainHe->Draw("ExTgtCor_R.th:ExTgtCor_R.ph>>HeThetaPhiNokinematics", cuts && vetoTDCs, "");
			...
			TString imageTitle = "/home/ellie/physics/e05-102/images/plots_for_hand/hand_theta_phi/";
			imageTitle += "plane_";
			imageTitle += nplane;
			imageTitle += "/hand_thph_plots_Run_Num_";
