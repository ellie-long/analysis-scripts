...
void add_beam_dsa_calibration_lt_q2_1() {
	...
	if (targ=="c")
	{
		if (includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/with_vetos/lt_carbon_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/with_vetos/q2_1_carbon/hand_beam_asym_vs_nu_for_run_20734.root") );
		...
		if (!includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/without_vetos/lt_carbon_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/without_vetos/q2_1_carbon/hand_beam_asym_vs_nu_for_run_20734.root") );
	...
	if (targ=="h")
	{
		if (includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/with_vetos/lt_hydrogen_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/with_vetos/q2_1_hydrogen/hand_beam_asym_vs_nu_for_run_20792.root") );
		...
		if (!includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/without_vetos/lt_hydrogen_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/without_vetos/q2_1_hydrogen/hand_beam_asym_vs_nu_for_run_20792.root") );
	...
	if (targ=="d")
	{
		if (includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/with_vetos/lt_deuterium_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/with_vetos/q2_1_deuterium/hand_beam_asym_vs_nu_for_run_20737.root") );
		...
		if (!includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/without_vetos/lt_deuterium_q2_1.root", "RECREATE" );
...
//			FileList->Add( TFile::Open("/work/halla/e05102/disk1/ellie/results/without_vetos/q2_1_deuterium/hand_beam_asym_vs_nu_for_run_20737.root") );
	...
	if (targ=="e")
	{
		if (includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/with_vetos/lt_empty_q2_1.root", "RECREATE" );
		...
		if (!includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/without_vetos/lt_empty_q2_1.root", "RECREATE" );
	...
	if (targ=="n")
	{
		if (includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/with_vetos/lt_nitrogen_q2_1.root", "RECREATE" );
		...
		if (!includeVetos)
		{
			Target = TFile::Open( "/home/ellie/physics/e05-102/analysis-scripts/devel/neutron_hunt/results/beam_dsa/without_vetos/lt_nitrogen_q2_1.root", "RECREATE" );
