...
#join -t ' ' <(sort vert_3he_q2_1_eeprime_asym_v_runnum_for_runs_20487-20511.txt) <(sort q2_1_charge.txt) > temp_q2_1_final.txt

#file0="./q2_1_final4.txt"
file0="temp_q2_1_final.txt"
awk '$1>20000 && $1<30000 && $29>0 && $31>0 && ($6+$8)>0 && $12>0 {print $1,$2,$3,$32*1.5577E-10,$34*1.5577E-10,$17*$38/$29,$20*$38/$31,sqrt((sqrt($4)^2)+((1/(sqrt($6+$8)))*($10/$12))^2),sqrt((sqrt($5)^2)+((1/(sqrt($7+$9)))*($11/$12))^2),$38,$17,$20,$29,$31 }' $file0 > temp_q2_1_evt_ch_lt.txt
...
#awk '$1>20000 && $1<30000 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 {print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3),$8*$8*$10/($4*$6)*sqrt(1/$11-1/$13+1/($8*$8)),$9*$9*$10/($5*$7)*sqrt(1/$12-1/$13+1/($9*$9))}' $file1 > temp_q2_1_yields.txt
awk '$1>20000 && $1<30000 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 {print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3),$2*$10/($4*$6)*sqrt(1/$11-1/$13+1/($2)),$3*$10/($5*$7)*sqrt(1/$12-1/$13+1/($3))}' $file1 > temp_q2_1_yields.txt
...
awk '$1>20000 && $1<30000 && ($2+$3)>0 {print $1,(($2-$3)/($2+$3))*(1/('$Pt'*'$DN2'*'$Dp')),(1/('$Pt'*'$DN2'*'$Dp'))*(2/((($2/$3)+1)^2))*($2/$3)*sqrt(($5/$2)^2+($6/$3)^2)}' $file2 > temp_final_q2_1_asym_runnum.txt
...
awk '$1>20000 && $1<30000 {print $1,$2,sqrt(($2*'$dDN2'/'$DN2')^2 + ($2*'$dDp'/'$Dp')^2 + ($2*'$dPt'/'$Pt')^2 + $3^2)}' $file9 > final_q2_1_asym_runnum.txt
#							Run #	Ay0		dAy0_tot
#							$1		$2		$3
...
#awk '$1>0.010 && $1<3 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 {print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3),$8*$8*7/($4*$6)*sqrt(1/'$totT2Up'-1/'$totScUp'+1/($8*$8)),$9*$9*7/($5*$7)*sqrt(1/'$totT2Dn'-1/'$totScDn'+1/($9*$9))}' $file4 > temp_q2_1_nu_yields.txt
awk '$1>0.010 && $1<3 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 {print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3),$2*7/($4*$6)*sqrt(1/'$totT2Up'-1/'$totScUp'+1/($2)),$3*7/($5*$7)*sqrt(1/'$totT2Dn'-1/'$totScDn'+1/($3))}' $file4 > temp_q2_1_nu_yields.txt
#							Run #	YieldUp		YieldDwn	1/sqrt(N)	dYup	dYdown
#							$1		$2			$3			$4			$5		$6

file5="./temp_q2_1_nu_yields.txt"
#awk '$1>0.010 && $1<3 && ($2+$3)>0 {print $1,($2-$3)/($2+$3),(2/((($2/$3)+1)^2))*($2/$3)*sqrt(($5/$2)^2+($6/$3)^2)}' $file5 > temp_final_q2_1_nu_asym.txt
#							Run #	Ay0		dAy0
#							$1		$2		$3
awk '$1>0.010 && $1<3 && ($2+$3)>0 {print $1,(($2-$3)/($2+$3))*(1/('$Pt'*'$DN2'*'$Dp')),(1/('$Pt'*'$DN2'*'$Dp'))*(2/((($2/$3)+1)^2))*($2/$3)*sqrt(($5/$2)^2+($6/$3)^2)}' $file5 > final_q2_1_nu_asym_stat.txt

file10="./final_q2_1_nu_asym_stat.txt"
awk '$1>0.010 && $1<3 {print $1,$2,$3,sqrt(($2*'$dDN2'/'$DN2')^2 + ($2*'$dDp'/'$Dp')^2 + ($2*'$dPt'/'$Pt')^2)}' $file10 > temp_q2_1_nu_asym_all.txt

file11="./temp_q2_1_nu_asym_all.txt"
echo "nu                  Ay0      e_stat       e_DN2         e_Dp         e_Pt       e_Spread" > final_q2_1_nu_asym_all_errs.txt
...
awk '$1>0.010 && $1<3 {print $1,$2,$3,$2*'$dDN2'/'$DN2',$2*'$dDp'/'$Dp',$2*'$dPt'/'$Pt',sqrt(('$S'^2-1)*(($2*'$dDN2'/'$DN2')^2 + ($2*'$dDp'/'$Dp')^2 + ($2*'$dPt'/'$Pt')^2 + $3^2))}' $file11 >> final_q2_1_nu_asym_all_errs.txt
#!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!*!

file12="./final_q2_1_nu_asym_all_errs.txt"
awk '$1>0.010 && $1<3 {print $1,$2,sqrt($3^2+$7^2),sqrt($4^2 + $5^2 + $6^2)}' $file12 > final_q2_1_nu_asym_stat_sys.txt
