...
//			asymOutFileText = HeRunNumber;
			asymOutFileText = "	 ";
			asymOutFileText += ybasic[i];
			asymOutFileText += "	";
			asymOutFileText += errorybasic[i];
			asymOutFileText += "	";
			asymOutFileText += UpEvents;
			asymOutFileText += "	";
			asymOutFileText += HeChargeScaleUp;
			asymOutFileText += "	";
			asymOutFileText += HelivetimeUp;
			asymOutFileText += "	";
			asymOutFileText += DownEvents;
			asymOutFileText += "	";
			asymOutFileText += HeChargeScaleDown;
			asymOutFileText += "	";
			asymOutFileText += HelivetimeDown;
		}
