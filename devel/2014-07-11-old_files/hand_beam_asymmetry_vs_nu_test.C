...
//	int whichbar=11;
	...
	for (int nplane=whichplane; nplane<endplane; nplane++)
	{
		...
		for (int thisbar=whichbar; thisbar<maxbars; thisbar++)
		{
			...
			TString firstTrackString = "NA.tr.firstplane[0]==";
			firstTrackString += (nplane - 1);
			firstTrackString += " && NA.tr.firstpad[0]==";
