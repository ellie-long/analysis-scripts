...
void firstTrack_hand_draw_antivetos(TString antiveto1plane, TString antiveto1bar, TString antiveto2plane, TString antiveto2bar, TString antiveto3plane, TString antiveto3bar, int HeRunNumber, int endHeRunNumber, TChain* chainHe, int TDCbins, double TDCmin, double TDCmax, TCut cuts, TCut goodTDCcut, TCut vetoTDCs, TString imageAntivetosTitle, int nplane, int thisbar, bool includeVetos, bool includeAntivetos, bool antivetosAsVetos, TString veto1plane, TString veto1bar, TString veto2plane, TString veto2bar, TString veto3plane, TString veto3bar, TString veto4plane, TString veto4bar, TString veto5plane, TString veto5bar, TString veto6plane, TString veto6bar, TString allVetos, TString allAntivetos){

	cout << "vvvvvvvvvvvvvvvvvvvvvvvvv firstTrack_hand_draw_antivetos.h vvvvvvvvvvvvvvvvvvvvvvvvvvv" << endl;

	TString firstTrackString = "NA.n.plane[0]==";
	firstTrackString += (nplane - 1);
	firstTrackString += " && NA.n.pad[0]==";
	firstTrackString += thisbar;
//	TString firstTrackString = "";
	TCut firstTrack = firstTrackString;

	TString firstVeto1TrackString = "NA.tr.firstplane==";
	firstVeto1TrackString += 2;
	firstVeto1TrackString += " && NA.tr.firstpad==";
	firstVeto1TrackString += 8;
	TString firstVeto1TrackString = "";
	TCut firstVeto1Track = firstVeto1TrackString;

	TString firstVeto2TrackString = "NA.tr.firstplane==";
	firstVeto2TrackString += 2;
	firstVeto2TrackString += " && NA.tr.firstpad==";
	firstVeto2TrackString += 9;
	TString firstVeto2TrackString = "";
	TCut firstVeto2Track = firstVeto2TrackString;

	TString firstVeto3TrackString = "NA.tr.firstplane==";
	firstVeto3TrackString += 2;
	firstVeto3TrackString += " && NA.tr.firstpad==";
	firstVeto3TrackString += 10;
	TString firstVeto3TrackString = "";
	TCut firstVeto3Track = firstVeto3TrackString;
	...
	if (includeVetos)
	{
		...
		chainHe->Draw(antiveto1leftTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto1Track,"same");
	}
	else
	{
		chainHe->Draw(antiveto1leftTDC, cuts,"");
		chainHe->Draw(antiveto1leftTDCcut, cuts && goodTDCcut && firstTrack && firstVeto1Track,"same");
	}
	...
	if (includeVetos)
	{
		...
		chainHe->Draw(antiveto1rightTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto1Track,"same");
	}
	else
	{
		chainHe->Draw(antiveto1rightTDC, cuts,"");
		chainHe->Draw(antiveto1rightTDCcut, cuts && goodTDCcut && firstTrack && firstVeto1Track,"same");
	}
	antiveto1right->Draw();
	...
	if (includeVetos) {
		...
		chainHe->Draw(antiveto2leftTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto2Track, "same");
	}
	else
	{
		chainHe->Draw(antiveto2leftTDC, cuts,"");
		chainHe->Draw(antiveto2leftTDCcut, cuts && goodTDCcut && firstTrack && firstVeto2Track,"same");
	}
	antiveto2left->Draw();
	...
	if (includeVetos)
	{
		...
		chainHe->Draw(antiveto2rightTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto2Track,"same");
	}
	else
	{
		chainHe->Draw(antiveto2rightTDC, cuts,"");
		chainHe->Draw(antiveto2rightTDCcut, cuts && goodTDCcut && firstTrack && firstVeto2Track,"same");
	}
	antiveto2right->Draw();
	...
	if (includeVetos)
	{
		...
		chainHe->Draw(antiveto3leftTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto3Track,"same");
	}
	else
	{
		chainHe->Draw(antiveto3leftTDC, cuts,"");
		chainHe->Draw(antiveto3leftTDCcut, cuts && goodTDCcut && firstTrack && firstVeto3Track,"same");
	}
	antiveto3left->Draw();
	...
	if (includeVetos)
	{
		...
		chainHe->Draw(antiveto3rightTDCcut, cuts && goodTDCcut && vetoTDCs && firstTrack && firstVeto3Track,"same");
	}
	else
	{
		chainHe->Draw(antiveto3rightTDC, cuts,"");
		chainHe->Draw(antiveto3rightTDCcut, cuts && goodTDCcut && firstTrack && firstVeto3Track,"same");
	}
	antiveto3right->Draw();
