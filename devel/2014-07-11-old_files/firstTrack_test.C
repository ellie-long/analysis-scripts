// ***************************************************
//
// This script is to help me understand how the firstTrack
// cut variables NA.tr.firstplace and NA.tr.firstpad 
// work
//
// 2011-03-25
// Elena Long
...
//	const int nuBins = 50;
	...
	TString outputPlotsHere = "/home/ellie/physics/e05-102/images/plots_for_hand/firstTrack/";
...
/*			handpad04->cd();
			cout << "Drawing Helicity Up vs. Nu..." << endl;
			TString titleSpinUpx = "Helicity Up vs. Nu for Plane #";
			titleSpinUpx += nplane;
			titleSpinUpx += ", PMT # ";
			...
			if (!includeVetos) {chainHe->Draw(HANDSpinDownxString, cuts && "((g0hel.R.helicity==-1 && g.runnum<22467) || (g0hel.R.helicity==1 && g.runnum>22468))","");}
