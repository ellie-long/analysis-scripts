...
def noEndRun(runnum):
	fSummary.write("\nRun Number " + runnum + " has no start of run file\n\n")
	events.write("Run Number " + runnum + " has no start of run file\n")
...
# Below doesn't work quite as hoped. See top text for details.
	...
	if (endRunNumber == "2009"):
		...
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "2183"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "2211"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "2220"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "2909"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3073"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3288"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3348"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3479"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3493"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "3564"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
