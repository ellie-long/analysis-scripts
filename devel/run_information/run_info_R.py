...
def noStartRun(runNum):
	fSummary.write("\nRun Number " + runNum + " has no start of run file\n\n")
	targettype.write("Run Number " + runNum + " has no start of run file\n")
	targetpol.write("Run Number " + runNum + " has no start of run file\n")
	beam_energy.write("Run Number " + runNum + " has no start of run file\n")
	bhwp.write("Run Number " + runNum + " has no start of run file\n")
	momentum.write("Run Number " + runNum + " has no start of run file\n")
	theta.write("Run Number " + runNum + " has no start of run file\n")

def noEndRun(runnum):
	fSummary.write("\nRun Number " + runnum + " has no end of run file\n\n")
	events.write("Run Number " + runnum + " has no end of run file\n")
...
# Below doesn't work quite as hoped. See top text for details.
	...
	if (endRunNumber == "20473"):
		...
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21432"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21508"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21603"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21620"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21627"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21938"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "21961"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22033"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22298"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22353"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22358"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22359"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22389"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
	if (endRunNumber == "22489"):
		fSummary.write("\nRun Number " + endRunNumber + " has no end of run file\n\n")
		events.write("Run Number " + endRunNumber + " has no end of run file\n")
		k += 1
