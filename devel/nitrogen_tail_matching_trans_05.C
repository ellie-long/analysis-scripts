...
void nitrogen_tail_matching_trans_05()
{

//	bool zoomed = false;
	bool zoomed = true;

	int thisHeRunNumber = 21712;
//	int thisNitroRunNumber = 22294;
	...
	int NitroRunNumber = 22283;
	int endNitroRunNumber = 22294;

	TString cutString = "ReactPt_R.z>-0.15 && ReactPt_R.z<0.17 && R.cer.asum_c>200 && ExTgtCor_R.th>-0.06 && ExTgtCor_R.th<0.06 && ExTgtCor_R.ph>-0.03 && ExTgtCor_R.ph<0.03";
...
//		filenameHe = "/home/ellie/physics/e05-102/ellana/ROOTfiles/q2_01_vert/e05102_R_";
	...
	chainHe->Draw("PriKineR.x_bj>>hex",cutString);
//	chainHe->Draw("PriKineR.x_bj>>hex");
	chainNitro->Draw("PriKineR.x_bj>>nitrox",cutString);
...
*/
	...
	chainHe->Draw("PriKineR.x_bj>>hexscaled",cutString);
//	chainHe->Draw("PriKineR.x_bj>>hexscaled");
	chainNitro->Draw("PriKineR.x_bj>>nitroxscaled",cutString);
