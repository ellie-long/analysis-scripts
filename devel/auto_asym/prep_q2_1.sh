...
home="."
bresults="$home/../../../results/q2_1_vert_3he"
chlt="$home/ch-lt/q2_1_vert"
...
cat $bresults/charge_lt_for_run_* > $bresults/q2_1_vert_3he_run_info.txt
rm $chlt/q2_1_ch-lt.txt
cat $chlt/charge_lt_for_run_* > $chlt/q2_1_ch-lt.txt
sed -i.bak "s/Run\ //g" $chlt/q2_1_ch-lt.txt
sed -i.bak ':a;N;$!ba;s/\n/\ /g' $chlt/q2_1_ch-lt.txt
sed -i.bak 's/\ \ /&\
/g' $chlt/q2_1_ch-lt.txt

# Add root files and analyze combined root file
analyzer $home/../add_root_files/add_vert_3he_q2_1.C
analyzer $home/../add_results/add_class_targ_asymmetry_vs_nu.C

# Run final analysis script and get results
#$home/q2_1_vert/get_ay0.sh
