...
void hand_class_veto_cuts(bool includeVetos, int nplane, int thisbar, TString& allVetos) 
{
...
//	cout << "vvvvvvvvvvvvvvvvvvvvvvvv hand_class_veto_cuts.h vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv" << endl;
