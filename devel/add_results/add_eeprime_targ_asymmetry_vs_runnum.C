...
//		of the data
//  2013-04-08
//		Changed to look at (e,e') asymmetry per nu bin
// 		that can be double-checked against Yawei's data
// ******************************************************
...
#include "hand_class_draw_eeprime_nu_run_by_run.h"
...
void add_eeprime_targ_asymmetry_vs_runnum(){
...
//		if (targ == "v") {HeStartRunNumber = 20487; endHeStartRunNumber = 20538;}
	...
	filenameHe += "_eeprime.root";

	TString asymOutFileName = outFileName;
	asymOutFileName += "_eeprime_asym_v_runnum_for_runs_";
...
// The section below plots the nu data
// **********************************************************************************************
//		hand_class_draw_basic(HeRunNumber, endHeRunNumber, drawCuts, kine, filenameHe, targ, outputPlotsHere);
//	hand_class_draw_nu(HeRunNumber, endHeRunNumber, filenameHe, kine, targ, asymOutFileText, includeVetos, nuBins, nuMin, nuMax, HeChargeScaleUp, HeChargeScaleDown, HelivetimeUp, HelivetimeDown, outputPlotsHere);
		cout << "Attempting draw_nu..." << endl;
		draw_nu(HeRunNumber, filenameHe, asymOutFileText);
		cout << "Did it work?" << endl;

		asymOutFile << asymOutFileText << endl;
//		asymOutFile << HeRunNumber << asymOutFileText << endl;
	} 
