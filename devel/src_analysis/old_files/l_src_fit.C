...
//  whattodraw += range;
  ...
  whattodrawHe += ">>histHe";
// NOTE: 0.161297 and 0.56541 are BCM u3 [ 0] values for all runs used
...
//	titleCoverHe += target;
	...
	TString imagename = "xbj_scaling_plots/longitudinal_xbj_scaling_plots_all_at_Q2_of_";
	imagename += Q2;
	imagename += ".png";
	c1->Print(imagename);
