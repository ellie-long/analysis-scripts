...
void test_src_chaining(){

  int CRunNumber=22380;
  int endCRunNumber=22395;
  int HeRunNumber=22407;
  ...
  for (int thisCRunNumber=CRunNumber; thisCRunNumber<(endCRunNumber+1); thisCRunNumber++)
  {
    for (int t=0; t<1000;t++)
    {
      ...
      else
      {
		...
		if(thisCRunNumber==22426){thisCRunNumber=22460;}
		if(thisCRunNumber==22389){thisCRunNumber=22424;}
