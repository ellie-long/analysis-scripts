...
/*	// Defines Cuts 1 Canvas
	...
	chainHe->Draw("ExTgtCor_R.dp>>HedpCut(400,-0.08,0.08)", dp, "");
	...
	cuts1pad05->cd();
        ...
        Hebottom = new TLine(-phbound,-thbound,phbound,-thbound);
        Hetop = new TLine(-phbound,thbound,phbound,thbound);
        Heleft = new TLine(-phbound,-thbound,-phbound,thbound);
        Heright = new TLine(phbound,-thbound,phbound,thbound);
	...
	cuts1pad06->Update();
        ...
        Hehistx->Sumw2();
        chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>Hehistx", cut && kinematics && eventtype && dp && target && thph && tracks && cerenkov && pssh, "E");
        chainHe->Draw("(PriKineR.Q2 / (PriKineR.nu * 2 * 0.9315))>>Hehistxcut", cuts, "E");
        Hehistx->Draw();
	...
	cuts2pad02->Update();
        ...
        TString titlePsSh = "3He Preshower and Shower - No Cuts";
	...
	cuts2pad05->cd();
        ...
        TString HetitlePsSh = "3He Preshower and Shower with cuts";
	...
	cuts2pad07->cd();
        ...
        TH1F *Hehistcerenkov = new TH1F("Hehistcerenkov",Hetitlecerenkov,200,-25,2000);
        TH1F *Hehistcerenkovcut = new TH1F("Hehistcerenkovcut",Hetitlecerenkov,200,-25,2000);
        chainHe->Draw("R.cer.asum_c>>Hehistcerenkov", "", "");
        chainHe->Draw("R.cer.asum_c>>Hehistcerenkovcut", cerenkov, "");
...
*/	xbjpad02->Update();
	...
	histHe->Sumw2();
	chainHe->Draw("PriKineR.x_bj>>histHe", cuts, "E");
...
*/	xbjpad03->Update();
	...
	loghistHe->Sumw2();
	chainHe->Draw("PriKineR.x_bj>>loghistHe", cuts, "E");
