...
void racunaj_n2()
{
  ...
  t1->SetBranchAddress( "NA.nd.p2.la", &BB_tp_e_LA);
  t1->SetBranchAddress( "NA.nd.p2.ra", &BB_tp_e_RA);
...
// ************* 1D - ADC - right side spectra ************************
  ...
  ofstream ERout;
  ERout.open("ped_data/more_ped_info/ND_n2_R_pedestals.dat");
 
  TString R_ADCHistogramName = "N2_R_ADC_pedestal_fits";
  ...
  for (int k = 0; k<NBARS; k++) {
    ...
    imagename="ped_data/ped_fit_pics/ND_n2_ADC_R_pedestal_fits.png";
...
// ************* 1D - ADC - left side spectra ************************
  ...
  ofstream ELout;
  ELout.open("ped_data/more_ped_info/ND_n2_L_pedestals.dat");
 
  TString L_ADCHistogramName = "N2_L_ADC_pedestal_fits";
  ...
  for (int k = 0; k<NBARS; k++) {
    ...
    imagename="ped_data/ped_fit_pics/ND_n2_ADC_L_pedestal_fits.png";
...
// transferred into the neutron detector database
  ...
  ofstream Eout;
  Eout.open("ped_data/ND_n2_pedestals.dat");
