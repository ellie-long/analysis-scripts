...
void racunaj_n3()
{
  ...
  t1->SetBranchAddress( "NA.nd.p3.la", &BB_tp_e_LA);
  t1->SetBranchAddress( "NA.nd.p3.ra", &BB_tp_e_RA);
...
// ************* 1D - ADC - right side spectra ************************
  ...
  ofstream ERout;
  ERout.open("ped_data/more_ped_info/ND_n3_R_pedestals.dat");
 
  TString R_ADCHistogramName = "N3_R_ADC_pedestal_fits";
  ...
  for (int k = 0; k<NBARS; k++) {
    ...
    imagename="ped_data/ped_fit_pics/ND_n3_ADC_R_pedestal_fits.png";
...
// ************* 1D - ADC - left side spectra ************************
  ...
  ofstream ELout;
  ELout.open("ped_data/more_ped_info/ND_n3_L_pedestals.dat");
 
  TString L_ADCHistogramName = "N3_L_ADC_pedestal_fits";
  ...
  for (int k = 0; k<NBARS; k++) {
    ...
    imagename="ped_data/ped_fit_pics/ND_n3_ADC_L_pedestal_fits.png";
...
// transferred into the neutron detector database
  ...
  ofstream Eout;
  Eout.open("ped_data/ND_n3_pedestals.dat");
